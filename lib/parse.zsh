...
#
# ```
# while true; do acrectl gce key | less -XE; sleep 1; done
# ```
#
...
function usage {
    ...
    function {
        ...
        if [[ $ACRECTL_MAN_FORMATTER = mandoc ]]; then
...
function completions {
    ...
    typeset state=seek mandoc=( '.TH ACRECTL-AGE 1 "AcreOps Manuals" "STOP" "AcreOps Manuals"' )
